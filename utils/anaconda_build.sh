...
conda convert --platform all ~/anaconda3/conda-bld/linux-64/bstore-1.0.0-py35_0.tar.bz2 -o ~/src/bstore-build

# Upload to anaconda
# anaconda login
anaconda upload ../bstore-build/linux-64/bstore-1.0.0-py35_0.tar.bz2
anaconda upload ../bstore-build/linux-32/bstore-1.0.0-py35_0.tar.bz2
